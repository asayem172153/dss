...
class personWithDisabilityPWDSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        foreach (range(1,500) as $value){
            DB::table('person_with_disability_pwd')->insert([
                'id'=> $value,
                'name'=>                        $faker->name(),
                'age'=>                         $faker->numberBetween(12, 99),
                'gender'=>                      $faker->randomElement(['Male', 'Female', 'Others']),
                'disability_type'=>             $faker->numberBetween(1, 10),
                ...
                'sports'=>                      $faker->numberBetween(1, 30),
                ...
                'depends_on_him/her'=>          $faker->numberBetween(1, 500),
                ...
                'medical_treatment'=>           $faker->numberBetween(1, 20),
                'is_family_support_for_treatment?'=>$faker->randomElement(['Yes', 'No']),
            ]);
        }
    }
}
